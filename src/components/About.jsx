  ...
  return (
    <>
      <div className="h-fit flex flex-col">
        ...
        <div className="w-100 relative text-white h-screen gap-5 flex flex-col items-center justify-center">
          <h1 className=" text-4xl">About</h1>
          <div></div>
          <img
            className="w-72 mt-1 drop-shadow-2xl rounded-lg border-orange-400"
          ...
          <div className="-bottom-3 absolute w-full z-0">
            <Wave
              fill="#1E3A8A"
              paused={false}
              options={{
